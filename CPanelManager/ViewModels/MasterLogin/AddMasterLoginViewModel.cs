...
{
    [Serializable()]
    public class AddMasterLoginViewModel
    {
        [Key]
        public long MasterLoginId { get; set; }

        [Required(ErrorMessage = "Select Registration Type!")]
        [Range(1, long.MaxValue, ErrorMessage = "Select Registration Type")]
        ...
        [Range(1, long.MaxValue, ErrorMessage = "Select Profile")]
