...
using CPanelManager.ViewModels.TransactionVendorFileUpload;
using Microsoft.AspNetCore.Http;

namespace CPanelManager.ViewModels.MasterVendor
{
    [Serializable()]
    public class AddMasterVendorViewModel
    {
        [Key]
        ...
        public List<ViewTransactionVendorFileUploadViewModel> ViewTransactionVendorFileUploadList { get; set; }
